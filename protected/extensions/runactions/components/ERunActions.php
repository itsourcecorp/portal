...
class ERunActions extends CWidget
{
	...
	public static function touchUrl($url,$postData=null,$contentType=null,$urlParams=array())
	{
        ...
        //changed this to be more da kine tricky 
		$urlParams = array_merge($urlParams,array('_runaction_touch'=>md5('runaction')));
        /*echo "$host,$port,$uri,$verb,$urlParams,$postData,$contentType</br>";
        print_r($urlParams);
        die();*/
